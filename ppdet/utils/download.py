...
WEIGHTS_HOME = osp.expanduser("/mnt/data/hzz/paddle_data/weights")
DATASET_HOME = osp.expanduser("/mnt/data/hzz/paddle_data/dataset")
CONFIGS_HOME = osp.expanduser("/mnt/data/hzz/paddle_data/configs")
